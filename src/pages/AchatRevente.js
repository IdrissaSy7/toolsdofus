...
const AchatRevente = () => {
  ...
  const handlePriceChange = (e) => {
    const value = e.target.value.replace(/[^\d\s]/g, ""); // Supprimer tous les caractères non numériques et non espaces
  ...
  return (
    <div>
      <Navigation />
      <div className="achatRevente">
        <div className="input">
          <h1 className="title">Outil d'Achat Revente</h1>
